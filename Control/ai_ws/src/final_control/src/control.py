...
class Waypoint:
    def __init__(self, max_speed = 40):
    ...
    def get_goal(self):
        self.goal_ind = self.way_ind + self.look_ahead_for_ts
        self.goal_waypoint = self.waypoints_[self.goal_ind]

        return self.goal_ind , self.goal_waypoint
...
def main():
    ...
    local_planner = test.LocalPlanner(7,1)
    ...
    while not rospy.is_shutdown():
        ...
        if len(waypoint.waypoints_)>0:
            ...
            # goal_ind, goal_way = waypoint.get_goal()

            # print(goal_ind , goal_way)
            # try:
            #     paths_ = local_planner.get_goal_state_set( goal_ind, goal_way, waypoint.waypoints_,waypoint.position_)
            #     print("5")
            ...
            #     #         # quaternion = quaternion_from_euler(0, 0, (paths[i][2][j]))


            #     #         # path_msg.pose.orientation.x = quaternion[0]
            #     #         # path_msg.pose.orientation.y = quaternion[1]
            #     #         # path_msg.pose.orientation.z = quaternion[2]
            #     #         # path_msg.pose.orientation.w = quaternion[3]
